                ...
                <div class="w3-content">
                    <form id="f1" action="predict.php" method="post">
                        ...
                        <div id="co">
                            ...
                            <div class="dropdown">
                                <!-- When this form is submitted, it'll set the 'runPrediction' POST variable -->
                                <form action="predict.php" method="post">
                                    <button type="submit" name="runPrediction" value="1">Run Stock Prediction</button>
                                </form>
                                <br>
                                <br>
                            </div>
            ...
            <footer class="footer-distributed">
                ...
                <div class="footer-center">
                    ...
                    <div>
                        ...
                        <p>
                            <a href="mailto:aj2529@nyu.edu">aj2529@nyu.edu</a>
                        </p>
                    </div>
                </div>
